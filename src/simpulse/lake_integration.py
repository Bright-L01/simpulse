...
from .diagnostic_parser import DiagnosticParser, DiagnosticAnalysis
...
"""
    ...
    def _lake_build_with_diagnostics(self, targets: Optional[List[str]] = None) -> str:
    ...
    def get_project_info(self) -> Dict[str, Union[str, List[str]]]:

...
def mock_lean_runner():
    ...
    mock_runner.profile_module = AsyncMock(return_value={
        "simp_time": 1.5,
        "total_time": 5.0,
        "memory_peak": 100.0,
        "iterations": 25
...
def sample_simp_rules():
    ...
    from simpulse.evolution.models import SimpRule, SimpPriority, SimpDirection
...
def mock_optimization_result():
    ...
    from simpulse.evolution.models import OptimizationResult, Candidate, AppliedMutation, MutationType

...
class TestSimpTheoremUsage:
    ...
    def test_success_rate_calculation(self):
        ...
        usage = SimpTheoremUsage(name="test_theorem", used_count=8, tried_count=10)
    ...
    def test_zero_division_in_success_rate(self):
        ...
        usage = SimpTheoremUsage(name="test_theorem", used_count=0, tried_count=0)
...
class TestDiagnosticAnalysis:
    ...
    def test_creation_with_data(self):
        ...
        analysis = DiagnosticAnalysis(total_theorems=2, total_files=1, theorem_usage=theorem_usage)
...
"""
    ...
    def test_parse_diagnostic_output_basic(self, parser, sample_diagnostic_output):
        ...
        list_append_nil = next(
            (t for t in analysis.theorem_usage if t.name == "list_append_nil"), None
        )
...
"""
    ...
    def test_parse_used_theorems_section(self, parser):
        ...
        lines = ["[simp] used theorems (max: 250, num: 2):", "  theorem1 ↦ 100", "  theorem2 ↦ 50"]

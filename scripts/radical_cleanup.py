...
'''
    ...
    def create_minimal_config(self):
        ...
        print(f"   📝 Creating minimal __init__.py")
...
'''
    ...
    def update_dependencies(self):
        ...
        for line in lines:
            if any(dep in line for dep in ['aiohttp', 'jinja2', 'prometheus', 'docker']):
                skip_next = True
                continue
        ...
        if req_path.exists():
            ...
            req_path.write_text("# No external dependencies - using only Python stdlib\n")

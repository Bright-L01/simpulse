...
class Publisher:
    ...
    async def run_tests(self) -> bool:
        ...
        try:
            ...
            # Run type checking
            self._run_command(["python", "-m", "mypy", "src/simpulse/", "--ignore-missing-imports"])
...
"""
    ...
    def _update_doc_versions(self):
        ...
        files_to_update = [
            ...
            self.docs_dir / "installation.md" if (self.docs_dir / "installation.md").exists() else None,
        ...
        for file_path in files_to_update:
            if file_path and file_path.exists():
                ...
                patterns = [
                    ...
                    (r'pip install simpulse==[0-9]+\.[0-9]+\.[0-9]+', f'pip install simpulse=={self.version}')
                ]
...
"""
    ...
    async def full_release(self, test_pypi: bool = True, deploy_docs: bool = True) -> bool:
        ...
        try:
            ...
            logger.info(f"🐙 GitHub: https://github.com/simpulse/simpulse/releases/tag/v{self.version}")
...
async def main():
    ...
    parser.add_argument("command", choices=["test", "build", "pypi", "github", "docs", "release"],
                       help="Command to run")
    parser.add_argument("--test-pypi", action="store_true", help="Use TestPyPI")
    parser.add_argument("--no-docs", action="store_true", help="Skip documentation deployment")

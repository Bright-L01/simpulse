    ...
    try:
        ...
        if mutation == "high_priority_add_zero":
            content = content.replace(
                "@[simp] theorem my_add_zero", "@[simp high] theorem my_add_zero"
            )
        elif mutation == "remove_zero_add":
            content = content.replace(
                "@[simp] theorem my_zero_add", "theorem my_zero_add"
            )
        elif mutation == "high_priority_mul_one":
            content = content.replace(
                "@[simp] theorem my_mul_one", "@[simp high] theorem my_mul_one"
            )

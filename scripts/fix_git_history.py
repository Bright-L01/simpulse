...
"""
    ...
    try:
        ...
        subprocess.run(["rm", "-rf", ".git/refs/original/"], capture_output=True)
        ...
        if result.returncode == 0:
            ...
            print(
                "⚠️  Other contributors will need to re-clone or reset their local repos"
            )
...
def alternative_approach():
    ...
    print("=" * 70)
    print(
        "This approach doesn't rewrite history but changes how authors are displayed."
    )
    print()
